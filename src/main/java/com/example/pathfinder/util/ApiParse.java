...
public class ApiParse {
    public static StringBuilder main(String keyword) throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("keyword","UTF-8") + "=" + keyword); /*검색어*/
        urlBuilder.append("&" + URLEncoder.encode("ContentTypeId","UTF-8") + "=" + "12"); /* 시설 id */
