...
public class ApiFesta {
    public static StringBuilder main(String Today) throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("EventStartDate","UTF-8") + "=" + "20230518"); /*축제시작일*/
        urlBuilder.append("&" + URLEncoder.encode("AreaCode","UTF-8") + "=" + "1"); /* 지역코드 */
